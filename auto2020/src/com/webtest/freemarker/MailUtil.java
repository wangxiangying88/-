...
public class MailUtil {
	...
	static String from = "ÍõÏæÓ±";
	static String user = "wangxiangyingemail@163.com";
	static String password = "TJZITZAEFGQHYSCQ";
	...
	public static void main(String args[]) throws UnsupportedEncodingException {
		MailUtil.sendEmail("wangxiangyingemail@163.com", "²âÊÔ", "²âÊÔÄÚÈÝ");
	}
